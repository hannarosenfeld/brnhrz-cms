		...
		<div>
			...
			>
				...
				>
					...
					<h3>
						<b>Direkte Hilfe, unbürokratisch und schnell.</b>
					</h3>
				</div>
			</div>
					...
					<div className="section">
										...
										<div className="circle-section">
											...
											<div
												dangerouslySetInnerHTML={{
													__html: converter.makeHtml(philosophie.kreise.first)
												}}
											/>
										</div>
										<div className="circle-section">
											...
											<div
												dangerouslySetInnerHTML={{
													__html: converter.makeHtml(philosophie.kreise.second)
												}}
											/>
										</div>
										<div className="circle-section">
											...
											<div
												dangerouslySetInnerHTML={{
													__html: converter.makeHtml(philosophie.kreise.third)
												}}
											/>
										</div>
									</div>
						...
						<div id="vorstand" style={{ margin: '4em auto 0 auto' }}>
							<div>
								...
								<div
									dangerouslySetInnerHTML={{
										__html: converter.makeHtml(vorstand.body)
									}}
								/>
								<img src={vorstand_foto} style={{ margin: '1em auto' }} />
								<p>
									Die Mitglieder des Vorstands (v.l.n.r.): Markus T. Schweizer,
									Rainer Mück, Dr. Andrea Degen, Andreas Wenzel
								</p>
							</div>
						</div>
					</div>
			...
			<div style={{ background: '#033277' }}>
				<div className="container">
					<div
						style={{ display: 'flex', margin: '0 auto', padding: '2em 0' }}
				...
				<div className="container">
					<div className="section">
						<div id="statuten" style={{ margin: '1em auto' }}>
							...
							<div
								dangerouslySetInnerHTML={{
									__html: converter.makeHtml(statuten.body)
								}}
							/>
						</div>
					</div>
