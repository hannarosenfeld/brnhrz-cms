					...
					<div className="signupform-checkbox-group mt-2">
						<div className="d-flex mt-4 mb-4">
							...
							<div className="d-flex">
								<input
									type="radio"
									value="ganzer Anlass (CHF 285,00)"
									name="teilnahme"
								/>
								...
								<input
									type="radio"
									value="nur Charity Golf Cup Gala (CHF 165.00)"
									name="teilnahme"
								/>
								<span className="m-1 p-1">
									nur Charity Golf Cup Gala (CHF 165.00)
								</span>
							</div>
						</div>
						...
						<Form.Group
							...
							controlId="formBasicBegleitung"
							style={{ width: '100%' }}
						>
							<p>Ich komme in Begleitung von:</p>
							<span style={{ margin: '0.8em' }} />
							<div
								className="flug-begleitung-info d-flex flex-column"
								style={{ width: '80%' }}
							>
								<div className="d-flex">
									<Form.Group
										controlId="formBasicBegleitungName"
										style={{ width: '45%' }}
									>
									...
									<Form.Group
										controlId="formBasicBegleitungHeimatClub"
										style={{ width: '55%' }}
									>
										<Form.Control
											type="text"
											name="begleitung-heimatclub-hcp"
										/>
										<Form.Label>Heimatclub, Hcp.</Form.Label>
									</Form.Group>
								</div>
						...
						<Form.Group className="mt-4" controlId="formBasicFlug">
							<Form.Check
								type="checkbox"
								className="text-info h5 mb-2"
								label="Wir möchten einen eigenen Flight buchen"
								name="flight"
							/>
							...
							<div className="d-flex">
								<Form.Group
									...
									controlId="formBasicFlugPersonEinsVorName"
								>
								...
								<Form.Group
									className="form-field"
									controlId="formBasicFlugpersoneinsName"
								>
								...
								<Form.Group
									className="form-field"
									controlId="formBasicFlugPersoneinsHcp"
								>
									<Form.Control
										type="text"
										name="flugperson-1-heimatclub-hcp"
									/>
									<Form.Label>Heimatclub, Hcp.</Form.Label>
								</Form.Group>
							</div>
							<div className="d-flex">
								<Form.Group
									className="form-field"
									controlId="formBasicFlugPersonZweiVorName"
								>
								...
								<Form.Group
									className="form-field"
									controlId="formBasicFlugPersonZweiName"
								>
								...
								<Form.Group
									className="form-field"
									controlId="formBasicFlugPersonZweiHcp"
								>
									<Form.Control
										type="text"
										name="flugperson-2-heimatclub-hcp"
									/>
									<Form.Label>Heimatclub, Hcp.</Form.Label>
								</Form.Group>
							</div>{' '}
							<div className="d-flex">
								<Form.Group
									className="form-field"
									controlId="formBasicFlugPersonDreiVorName"
								>
								...
								<Form.Group
									className="form-field"
									controlId="formBasicFlugPersonDreiName"
								>
								...
								<Form.Group
									className="form-field"
									controlId="formBasicFlugPersonDreiHcp"
								>
									<Form.Control
										type="text"
										name="flugperson-3-heimatclub-hcp"
									/>
									<Form.Label>Heimatclub, Hcp.</Form.Label>
								</Form.Group>
							</div>{' '}
							<div className="d-flex">
								<Form.Group
									className="form-field"
									controlId="formBasicFlugPersonVierVorName"
								>
								...
								<Form.Group
									className="form-field"
									controlId="formBasicFlugPersonVierName"
								>
								...
								<Form.Group
									className="form-field"
									controlId="formBasicFlugPersonVierHcp"
								>
									<Form.Control
										type="text"
										name="flugperson-4-heimatclub-hcp"
									/>
									<Form.Label>Heimatclub, Hcp.</Form.Label>
								</Form.Group>
							</div>
						...
						<div className="mt-4">
							<p>
								<b>
									Bitte überweisen Sie das entsprechende Startgeld mit Ihrer
									Anmeldung unter dem Betreff «Charity Golf Cup 2022» auf das
									Bärenherz Konto: CH91 0078 4297 6098 0200 1 bei der Thurgauer
									Kantonalbank. Die Teilnehmerzahl des Golfturniers ist auf 48
									Personen begrenzt. Das Datum des Eingangs der Überweisung
									entscheidet bei zu grosser Nachfrage.
								</b>
							</p>
							<div className="mt-2 mb-4">
								<Form.Group className="" controlId="formBasicCheckboxFoto">
									<Form.Check
										type="checkbox"
										...
										name="einverstanden-foto"
									/>
								</Form.Group>
								<Form.Group
									className=""
									controlId="formBasicCheckboxNewsletter"
								>
									<Form.Check
										type="checkbox"
										label="Bitte informieren Sie mich regelmäßig per E-mail Newsletter über Neuigkeiten rund um Bärenherz e.V."
										name="newsletter"
									/>
								</Form.Group>
							</div>
