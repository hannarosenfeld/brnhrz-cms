    ...
    <Layout>
      <div style={{margin: "0 auto"}}>
        ...
        <br/>
           ...
           <br/>
           <br/>
           <h4 id="golf" style={{fontSize: "2em", fontWeight: "bold"}}>Übergabe Golf Charity Erlöse an Project HOPE e.V.</h4>
           <br/>
        ...
        <div style={{width: "75%", margin: "0 auto"}}>
          ...
          Bei so viel Optimismus hatte dann auch der Wettergott ein Einsehen und nach gut einer Stunde war der Regen vorbei und es entwickelte sich ein schöner Tag auf einer noch schöneren Golfanlage.
          <br/>
          <br/>
          Bereits zur Halfway Verpflegung konnten wir erleichtert feststellen: Die Stimmung bei allen Beteiligten ist sehr gut! Also gab es erst einmal eine verdiente Stärkung und nach Ghackets mit Hörnli, Wurst-Käse-Salat oder einem feinen Sandwich und dem einen oder anderen Glas Bier wurde die 2. Hälfte des Platzes in Angriff genommen.
          Hier strahlte dann nicht nur die Sonne, sondern auch die Teilnehmer hatten sichtlich Spass. So konnten wir gut gelaunte Golfer nach der Runde zu einem Grillimbiss begrüssen. Ian Gibbons, der Clubmanager des Golfclub Lipperswil, liess es sich nicht nehmen, leckere Bratwürste und Hamburger für die hungrigen Golfer persönlich zuzubereiten. Hier wurden die Ergebnisse ausgiebig diskutiert und es gab das eine oder andere überraschende freudige Wiedersehen.
          <br/>
          <br/>
          ...
          <br/>
          <br/>
          Und es wurden viele Lose gekauft, um die gute Sache zu unterstützen. Viele freuten sich über tolle Gewinne: Hotelgutscheine, Greenfees, Parfum und viele weitere Preise fanden glückliche Gewinner.
          Gewinner gab es natürlich auch beim Golf: Andreas Bühlmann, Erwin Höfliger und Peter Mastelic konnten sich als erste Gewinner auf dem Wanderpokal  - unser Bärenherz – eintragen. Aber ihnen war auch zu diesem Zeitpunkt schon bewusst, die Titelverteidigung im nächsten Jahr wird nicht einfach werden!
          <br/>
          <br/>
        ...
        <div id="perimac" style={{background : "#EEEAE4"}}>
          ...
          <br/>
            <h4 style={{fontSize: "2em", fontWeight: "bold"}}>PeriMAC – das erste Projekt</h4>
            <p>von Rainer Mück</p>
          <br/>
        ...
        <div id="skiwochenende" style={{width: "75%", margin: "0 auto"}}>
          ...
          Marie-Therese Nadig, Urs Kälin, Andreas Spieth und ich erwarten Euch als Coaches am Freitagabend im Hotel Neu-Schönstatt.
          Nachdem wir unsere Test-Ski angepasst haben, starten wir am Samstagmorgen gemeinsam in das Skigebiet und werden als Gruppe einen gemeinsamen Schwung-Rhythmus finden.
          <br/>
          <br/>

          Embodied Skiing ist das Zauberwort, mit dem wir uns mit unserer Aufmerksamkeit in den eigenen Körper hineinbegeben und beim rhythmischen Fahren erforschen, was in unseren Gelenken passiert, welche Muskeln arbeiten und wie sich die Körperspannung anfühlt.
          Kurzum: Beim Skifahren Bewusstheit trainieren.
          <br/>
          <br/>
          ...
          Am Samstagabend geht Bärenherz Gourmet ins Restaurant Schlüssel zu Roger Kalberer - Ein gastronomisches Highlight!
          Das Pünktchen auf dem „i“ ist unsere Preisziehung, Ski mit Bindung, weiter 2-Tageskarten der Bergbahnen Flums und 1 Übernachtung für 2 Personen sowie die Versteigerung eines Heli-Ski-Tages von Aeroski-Reisen für 4 Personen in Courmayeur.
          <br/>
          <br/>
          ...
          Am Sonntag werden wir als Gruppen versuchen, möglichst synchron und von einer Drohne verfolgt, ins Tal zu fahren.
          Die beste Truppe erhält unseren aus Holz geschnitzten „Ski-Bären-Wanderpokal“ von Paul Widmer!
          <br/>
          <br/>
